...
A datasheet for the KrakenSDR is available at [https://github.com/krakenrf/krakensdr_docs/blob/main/paper_manual/KrakenSDR%20Datasheet.pdf](https://github.com/krakenrf/krakensdr_docs/blob/main/paper_manual/KrakenSDR%20Datasheet.pdf)
...
On the Orange Pi 5 or Pi 5, you can use the network manager GUI in the desktop OS to change WiFi credential information.
...
On the Orange Pi 5 and Raspberry Pi 5, you can use the built-in network manager GUI as part of the OS.
...
* Upgraded Linux Kernel for Raspberry Pi 5 2GB compatibility